...
#####################################################################
#
# degree 72, class group Z/7 x Z/28 x Z/64, norm relation denominator 1
# classic PIP in degree <= 6, saturation/roots in degree <= 24
#
# Norm Relation: ~4 sec
# PIP: ~2.1 min
#
...
println("Classic PIP done in subfields of degree <= 6, root computation in degree <= 24.")
